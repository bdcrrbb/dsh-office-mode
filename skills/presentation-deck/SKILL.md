...
description: Structure presentations for a specific audience and decision — 演示文稿/汇报/PPT 的内容结构与叙事设计。Use when planning slide content, structuring a deck, preparing 汇报/述职/提案/评审 presentations. For a portfolio narrative use `case-study`; for the written argument use `design-rationale`.
---
# Presentation Deck
